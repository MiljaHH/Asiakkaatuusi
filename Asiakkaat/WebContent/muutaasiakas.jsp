...
.then( function (responseJson) {//Otetaan vastaan objekti responseJson-parametrissä	
	...
	document.getElementById("etunimi").value = responseJson.rekno;		
	document.getElementById("sukunimi").value = responseJson.merkki;	
	document.getElementById("puhelin").value = responseJson.malli;	
	document.getElementById("sposti").value = responseJson.vuosi;	
	document.getElementById("asiakas_id").value = responseJson.rekno;	
});	
